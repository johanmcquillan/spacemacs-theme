...
(defun create-spacemcq-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (bg1           (if (eq variant 'dark) (if (true-color-p) "#000000" "#262626") (if (true-color-p) "#fbf8ef" "#ffffff")))
        (bg2           (if (eq variant 'dark) (if (true-color-p) "#1c1c1c" "#1c1c1c") (if (true-color-p) "#efeae9" "#e4e4e4")))
        (bg3           (if (eq variant 'dark) (if (true-color-p) "#292929" "#1c1c1c") (if (true-color-p) "#efeae9" "#e4e4e4")))
        (bg4           (if (eq variant 'dark) (if (true-color-p) "#515151" "#121212") (if (true-color-p) "#e3dedd" "#d0d0d0")))
        ...
        (comment-bg    (if (eq variant 'dark) (if (true-color-p) "#141414" "#262626") (if (true-color-p) "#ecf3ec" "#ffffff")))
