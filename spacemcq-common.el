...
(defun create-spacemcq-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (bg2           (if (eq variant 'dark) (if (true-color-p) "#141414" "#1c1c1c") (if (true-color-p) "#efeae9" "#e4e4e4")))
        ...
        (comment-bg    (if (eq variant 'dark) (if (true-color-p) "#1c1c1c" "#262626") (if (true-color-p) "#ecf3ec" "#ffffff")))
